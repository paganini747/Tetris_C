...
int Level = 1;//等级
int Score = 0;//积分
#define c1	2	//绿  		L形                      //黑色=0     蓝色=1      绿色=2      浅绿色=3
#define c2	8	//灰  		T形                      //红色=4     紫色=5      黄色=6      白色=7
#define c3	15	//白  	 长条形                      //灰色=8     淡蓝色=9    淡绿色=10   单浅绿色=11
#define c4	4	//红	 	Z形                      //淡红色=12  淡紫色=13   淡黄色=14   亮白色=15
#define c5	1	//蓝 	 方块形 
